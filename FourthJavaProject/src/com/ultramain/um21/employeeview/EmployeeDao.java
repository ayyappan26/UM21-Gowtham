package com.ultramain.um21.employeeview;
...
public class EmployeeDao {
	...
	public HashMap<Integer,EmployeeDto> viewOneEmployees() throws SQLException{
		...
		int b=scan.nextInt();
		Connection con= DataConnect .getDbConnection();
		String sql="SELECT Employee_id,First_name,Last_name,Salary,Mobile,Department FROM emp WHERE Employee_id=?";
	...
	public void printDetails(HashMap<Integer,EmployeeDto> resultMap){
		for(Integer key : resultMap.keySet() ) {
			...
			System.out.println("Employee Department    :"+((EmployeeDto) resultMap.get(key)).getDept());
			System.out.println("-----------------------------------------");
	}
