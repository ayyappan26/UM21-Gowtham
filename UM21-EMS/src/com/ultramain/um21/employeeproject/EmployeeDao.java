...
public void viewOneEmp() throws SQLException {
	    ...
	    int a=scan.nextInt();
		Connection con = DataConnect.getDbConnection();
		String sqlQry = "select employee_id,first_name,last_name,salary,mobile,department from emp where employee_id=?";
	...
	/**
	 * This method used to altering the existing data in database
	 * @param empDto
	 * @throws SQLException
	 */
	public void updateEmployees(EmployeeDTO empDto) throws SQLException{
		...
		Connection con = DataConnect.getDbConnection();
		String updateQuery = "update emp set first_name=?,last_name=?, salary=?,mobile=?,department=? where employee_id=?";
